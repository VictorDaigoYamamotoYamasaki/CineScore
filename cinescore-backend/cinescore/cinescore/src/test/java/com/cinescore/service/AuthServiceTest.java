...
class AuthServiceTest {
    ...
    private static final String USER_ID = "uuid-maria-001";
    ...
    void configurar() {
        usuarioMock = User.builder()
                .id(USER_ID).name("Maria").email("maria@test.com")
    ...
    @Test
    @DisplayName("Deve retornar userId (UUID) no response de registro")
    void deveRetornarUserIdNoRegistro() {
        UserRequestDTO dto = new UserRequestDTO();
        dto.setName("Maria"); dto.setEmail("maria@test.com"); dto.setPassword("Senha@123");
    ...
    @Test
    @DisplayName("Deve lançar ContentModerationException quando nome de usuário é ofensivo")
    void deveLancarExcecaoQuandoNomeEOfensivo() {
        UserRequestDTO dto = new UserRequestDTO();
        dto.setName("NomeOfensivo"); dto.setEmail("x@test.com"); dto.setPassword("Senha@123");

        doThrow(new ContentModerationException("nome de usuário"))
                .when(moderationService).verificar("NomeOfensivo", "nome de usuário");
    ...
    @Test
    @DisplayName("Deve verificar se nome já está em uso durante o registro")
    void deveVerificarNomeDuranteRegistro() {
        UserRequestDTO dto = new UserRequestDTO();
        dto.setName("Maria"); dto.setEmail("maria@test.com"); dto.setPassword("Senha@123");
        ...
        verify(userService).validateNameNotInUse("Maria", null);
    }
}
