...
public class AdminController {
    ...
    public ResponseEntity<java.util.List<RatingDistributionDTO>> distribuicaoNotas() {
        return ResponseEntity.ok(adminService.distribuicaoDeNotas());
    }

    @GetMapping("/stats/reviews-per-day")
    public ResponseEntity<java.util.List<ReviewsPerDayDTO>> reviewsPorDia() {
        return ResponseEntity.ok(adminService.reviewsPorDia());
    }

    @GetMapping("/stats/genres")
    public ResponseEntity<java.util.List<GenreCountDTO>> generos() {
