...
import com.cinescore.security.JwtAuthenticationFilter;
import com.cinescore.service.UserService;
import com.cinescore.filter.RateLimitGlobalFilter;
import com.cinescore.filter.RateLimitUsuarioFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/watchlist/user/**").permitAll()
